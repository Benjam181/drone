...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM2)
  {
    ...
    PA15 (JTDI)     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(ROLL_INPUT_PWM_GPIO_Port, ROLL_INPUT_PWM_Pin);
  ...
  else if(htim_base->Instance==TIM3)
  {
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(PITCH_INPUT_PWM_GPIO_Port, PITCH_INPUT_PWM_Pin);
  ...
  else if(htim_base->Instance==TIM4)
  {
    ...
    PB6     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(TRHUST_INPUT_PWM_GPIO_Port, TRHUST_INPUT_PWM_Pin);
  ...
  else if(htim_base->Instance==TIM5)
  {
    ...
    PA0     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(YAW_INPUT_PWM_GPIO_Port, YAW_INPUT_PWM_Pin);
